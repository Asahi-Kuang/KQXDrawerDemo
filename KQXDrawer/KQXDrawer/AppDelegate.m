...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [self.window setBackgroundColor:RGBA(255, 255, 255, 1)];
    ...
    self.leftSlideVC = [[LeftSlideViewController alloc] initWithLeftViewController:left withMainViewController:self.mainNav];
